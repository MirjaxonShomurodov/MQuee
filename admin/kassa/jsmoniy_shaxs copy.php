...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="bi bi-speedometer"></i>Jsmoniy shaxslar uchun </h1>
          <p>Jsmoniy shaxslar foydalanish mumkin.</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">  
          <li class="breadcrumb-item"><i class="bi bi-house-door fs-6"></i></li>
          <li class="breadcrumb-item"><a href="navbat.php">1</a></li>
          <li class="breadcrumb-item"><a href="navbat-add.php">2</a></li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md-6">

...
<!-- Font-icon css-->
<link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.10.5/font/bootstrap-icons.css">  </head>
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview">
            <i class="app-menu__icon bi bi-laptop"></i><span class="app-menu__label">Kassa</span>
            <i class="treeview-indicator bi bi-chevron-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="yurdik_shaxs.php"><i class="icon bi bi-circle-fill"></i> Yuridik shaxslar uchun kassa </a></li>
          </ul>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="jsmoni_shaxs.php"><i class="icon bi bi-circle-fill"></i> Jismoniy shaxslar uchun kassa </a></li>
          </ul>
        </li>
      </ul>
      <ul class="app-menu">
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview">
            <i class="app-menu__icon bi bi-laptop"></i><span class="app-menu__label">Valyuta ayriboshlash</span>
            <i class="treeview-indicator bi bi-chevron-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="pul_utkazma.php"><i class="icon bi bi-circle-fill"></i> Pul o'tkazmalari va depozitkar </a></li>
          </ul>
        </li>
      </ul>
...
<script src="../assets/admin/js/jquery-3.7.0.min.js"></script>
